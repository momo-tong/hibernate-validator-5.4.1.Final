 ...
 */
@Generated(value = "org.jboss.logging.processor.generator.model.MessageBundleImplementor", date = "2017-03-16T17:15:39+0000")
public class Messages_$bundle implements Messages, Serializable {
    ...
    public final String unableToFindScriptEngine(final String languageName) {
        return String.format(getLoggingLocale(), unableToFindScriptEngine$str(), languageName);
    }
